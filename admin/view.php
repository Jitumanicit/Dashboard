...
<head>
    <meta charset="UTF-8">
    <title>Admin || User Recognition Record</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Recognition History</h2>
                        <p class="pull-right">
                ...
                if(isset($_GET["identification_no"]) && !empty(trim($_GET["identification_no"]))){
                    ...
                    $sql = "SELECT * FROM recognition_result WHERE identification_no = ?";
                            ...
                            $result = mysqli_stmt_get_result($stmt);
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='delete_history.php?id=". $row['id'] ."' title='Delete History' data-toggle='tooltip'><span class='glyphicon glyphicon-remove'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
